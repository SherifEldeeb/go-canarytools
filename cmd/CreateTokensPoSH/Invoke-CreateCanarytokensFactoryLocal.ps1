...
.NOTES
    ...
    if you don't know how, please rech out to support@canary.tools.

    If FlockID is not provided, it will drop the tokens to the default flock.

    ###################
    How does this work?
    ###################
    1. Creat the flock you want the tokens to be part of in your console.
    ...
    4. Make ure the host has access to the internet.
...
Param (
    ...
    # Factory Auth token, 
    # you can read more about Factory here: https://docs.canary.tools/canarytokens/factory.html#factory
    # if empty, will be asked for interactively 
    [string]$FactoryAuth = '',

    # Flock ID
    # this must exist before running the tool
    [string]$FlockID = 'flock:default',
...
$ApiBaseURL = '/api/v1'
# Factory Does not support pinging console.
